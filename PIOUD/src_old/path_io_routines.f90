...
! the default is not the same as in pw .... all atoms are fixed by default ....
     ...
     !!!         activation_energy + ( pes(1) - pes(num_of_images) ) * autoev    !!! <----my mod.
       ...
       !
      !!! IF ( CI_scheme == "auto" ) &   !!! <----my mod.
      !!!    WRITE( UNIT = iunpath, &    !!! <----my mod.
      !!!           FMT = '(/,5X,"climbing image = ",I2)' ) Emax_index   !!! <----my mod.
       !
      !!!  WRITE( UNIT = iunpath, &   !!! <----my mod.
      !!!         FMT = '(/,5X,"path length",&   !!! <----my mod.
      !!!                & T26," = ",F6.3," bohr")' ) path_length  !!! <----my mod.
      !!! WRITE( UNIT = iunpath, &   !!! <----my mod.
      !!!         FMT = '(5X,"inter-image distance", &   !!! <----my mod.
      !!!                & T26," = ",F6.3," bohr")' ) inter_image_distance  !!! <----my mod.
       !
