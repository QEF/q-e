...
10     CONTINUE
     ...
     SUBROUTINE stres_us_k()
       ...
       !*********
       COMPLEX(DP), ALLOCATABLE :: ps_ncv(:,:)
       COMPLEX(DP), ALLOCATABLE :: becpnc_h(:,:,:)
       !**********
