...
#include "machine.h"
  ...
  complex(kind=DP), pointer :: spsi (:), lagrange (:), &
  ...
  call mallocate(spsi,nmax)  
  call mallocate(scg, nmax)  
  call mallocate(hpsi,nmax)  
  call mallocate(g,   nmax)  
  call mallocate(cg,  nmax)  
  call mallocate(g0,  nmax)  
  call mallocate(ppsi,nmax)  
  call mallocate(lagrange, nbnd)
