...
module fbuf
  ...
  !
  type ivb_t
    integer, device, contiguous, pointer  :: data_d(:)
    integer :: dsize
    logical :: locked
  end type ivb_t
  ...
  type rvb_t
    real(DP), device, contiguous, pointer  :: data_d(:)
    integer :: dsize
    logical :: locked
  end type rvb_t
  ...
  type cvb_t
    complex(DP), device, contiguous, pointer  :: data_d(:)
    integer :: dsize
    logical :: locked
  end type cvb_t
  ...
  subroutine lock_buffer_iv(this, p, vsize, info)
    ...
    do i=1,this%nbufs
      ...
      if ( this%ivb(i)%dsize >= vsize ) then
        if (.not. allocated(this%ivb(i)%data_d)) stop 
        ...
        if (info /= 0) then 
            write(*,*) 'Could not allocate buffer! Program will abruptly stop.'
            stop
        end if
  ...
  subroutine lock_buffer_im(this, p, msize, info)
    ...
    do i=1,this%nbufs
      ...
      if (ALL( this%imb(i)%dsize >= msize )) then
        if (.not. allocated(this%imb(i)%data_d)) stop 
  ...
  subroutine lock_buffer_it(this, p, tsize, info)
    ...
    do i=1,this%nbufs
      ...
      if (ALL( this%itb(i)%dsize >= tsize )) then
        if (.not. allocated(this%itb(i)%data_d)) stop 
  ...
  subroutine lock_buffer_rv(this, p, vsize, info)
    ...
    do i=1,this%nbufs
      ...
      if ( this%rvb(i)%dsize >= vsize ) then
        if (.not. allocated(this%rvb(i)%data_d)) stop 
  ...
  subroutine lock_buffer_rm(this, p, msize, info)
    ...
    do i=1,this%nbufs
      ...
      if (ALL( this%rmb(i)%dsize >= msize )) then
        if (.not. allocated(this%rmb(i)%data_d)) stop 
  ...
  subroutine lock_buffer_rt(this, p, tsize, info)
    ...
    do i=1,this%nbufs
      ...
      if (ALL( this%rtb(i)%dsize >= tsize )) then
        if (.not. allocated(this%rtb(i)%data_d)) stop 
  ...
  subroutine lock_buffer_cv(this, p, vsize, info)
    ...
    do i=1,this%nbufs
      ...
      if ( this%cvb(i)%dsize >= vsize ) then
        if (.not. allocated(this%cvb(i)%data_d)) stop 
  ...
  subroutine lock_buffer_cm(this, p, msize, info)
    ...
    do i=1,this%nbufs
      ...
      if (ALL( this%cmb(i)%dsize >= msize )) then
        if (.not. allocated(this%cmb(i)%data_d)) stop 
  ...
  subroutine lock_buffer_ct(this, p, tsize, info)
    ...
    do i=1,this%nbufs
      ...
      if (ALL( this%ctb(i)%dsize >= tsize )) then
        if (.not. allocated(this%ctb(i)%data_d)) stop 
