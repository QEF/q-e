...
MODULE exch_lda_gpu  !<GPU:exch_lda_gpu=>exch_lda_gpu>
!
...
attributes(DEVICE) &
#endif
SUBROUTINE slater_rxc_d (rs,ex,vx)
...
attributes(DEVICE) &
#endif
SUBROUTINE slaterKZK_d (rs,ex,vx,vol)
...
attributes(DEVICE) &
#endif
SUBROUTINE slater_spin_d (rho,zeta,ex,vx_up,vx_dw)
...
attributes(DEVICE) &
#endif
SUBROUTINE slater_rxc_spin_d (rho,z,ex,vx_up,vx_dw)
  ...
  RETURN
  !
END SUBROUTINE slater_rxc_spin_d
!
!
!-----------------------------------------------------------------------
#if defined(__CUDA)
attributes(DEVICE) &
#endif
SUBROUTINE slater1_spin_d (rho,zeta,ex,vx_up,vx_dw)
