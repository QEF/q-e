...
!       USE control_flags,    ONLY : lneb, lsmd, lcoarsegrained
       ...
       USE path_variables_pre,   ONLY : climbing, nstep_path, num_of_images, &
...
!       USE control_flags,          ONLY : lsmd, lcoarsegrained
       ...
       USE path_variables_pre,         ONLY : istep_path, nstep_path, frozen, dim1,&
                                          pending_image, pos, pes, grad_pes,   &
                                          lquick_min, posold, Emax, Emin,      &
                                          Emax_index
       USE path_reparametrisation_pre, ONLY : spline_interpolation
       !
       IMPLICIT NONE
       !
       INTEGER            :: i, j, ia, ierr
...
!       USE control_flags,    ONLY : conv_elec, lcoarsegrained
       ...
       USE path_variables_pre,   ONLY : istep_path, nstep_path, pending_image, &
                                    dim1, num_of_images, pos, pes, grad_pes, &
                                    posold, frozen, lquick_min
       USE path_formats_pre,     ONLY : energy, restart_first, restart_others, &
                                    quick_min
       !
       IMPLICIT NONE
       !
...
!       USE control_flags,    ONLY : lcoarsegrained
       ...
       USE path_formats_pre,     ONLY : dat_fmt, int_fmt, xyz_fmt, axsf_fmt
       USE path_variables_pre,   ONLY : pos, grad_pes, pes, num_of_images, &
                                    tangent, dim1, error
...
!       IF ( lcoarsegrained ) RETURN
     ...
     SUBROUTINE write_output()
       ...
       !
       USE io_files,       ONLY : iunpath
       USE path_variables_pre, ONLY : num_of_images, error, path_length, &
                                  activation_energy, pes, pos, frozen, &
                                  CI_scheme, Emax_index
       USE path_formats_pre,   ONLY : run_info, run_output
       !
       IMPLICIT NONE
       !
       ! ... local variables
     ...
     SUBROUTINE new_image_init( fii, outdir )
       ...
       USE path_variables_pre, ONLY : tune_load_balance
     ...
     !
END MODULE path_io_routines_pre
