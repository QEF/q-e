!
MODULE corr_gga_gpu                       !<GPU:corr_gga_gpu=>corr_gga_gpu>
  !
  USE corr_lda_gpu,  ONLY : pw_d, pw_spin_d   !<GPU:pw_spin_d=>pw_spin_d,pw_d=>pw_d,corr_lda_gpu=>corr_lda_gpu>
  !
CONTAINS
!
!-----------------------------------------------------------------------
...
attributes(DEVICE) &
#endif
SUBROUTINE perdew86_d (rho,grho,sc,v1c,v2c)
...
attributes(DEVICE) &
#endif
SUBROUTINE ggac_d (rho,grho,sc,v1c,v2c)
  ...
  rs = pi34 / rho**third
  !
  CALL pw_d( rs, 1, ec, vc )                                  !<GPU:pw_d=>pw_d>
  !
  rs1 = rs
  rs2 = rs1 * rs1
  rs3 = rs1 * rs2
...
attributes(DEVICE) &
#endif
SUBROUTINE glyp_d (rho,grho,sc,v1c,v2c)
...
attributes(DEVICE) &
#endif
SUBROUTINE pbec_d (rho,grho,iflag,sc,v1c,v2c)
...
INTEGER, VALUE, intent(IN) :: iflag
  ...
  ! q2D
  IF (iflag == 3) THEN
     CALL cpbe2d_d( rho, grho, sc2D, v1c2D, v2c2D )       !<GPU:cpbe2d_d=>cpbe2d_d>
     sc  = sc  + sc2D
     v1c = v1c + v1c2D
     v2c = v2c + v2c2D
  ENDIF
...
attributes(DEVICE) &
#endif
SUBROUTINE perdew86_spin_d (rho,zeta,grho,sc,v1c_up,v1c_dw,v2c)
  ...
  RETURN
  !
END SUBROUTINE perdew86_spin_d
!
!
!-----------------------------------------------------------------------
#if defined(__CUDA)
attributes(DEVICE) &
#endif
SUBROUTINE ggac_spin_d (rho,zeta,grho,sc,v1c_up,v1c_dw,v2c)
  ...
  rs = pi34 / rho**third
  !
  CALL pw_spin_d( rs, zeta, ec, vc_up, vc_dn )                                 !<GPU:pw_spin_d=>pw_spin_d>
  !
  rs2 = rs * rs
  rs3 = rs * rs2
  kf = xkf / rs
...
attributes(DEVICE) &
#endif
SUBROUTINE pbec_spin_d (rho,zeta,grho,iflag,sc,v1c_up,v1c_dw,v2c)
...
attributes(DEVICE) &
#endif
SUBROUTINE lsd_glyp_d (rho_in_up,rho_in_dw,grho_up,grho_dw,grho_ud,sc,v1c_up,v1c_dw,v2c_up,v2c_dw,v2c_ud)
...
attributes(DEVICE) &
#endif
SUBROUTINE cpbe2d_d (rho,grho,sc,v1c,v2c)
