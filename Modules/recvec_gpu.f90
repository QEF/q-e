...
!=----------------------------------------------------------------------------=!
     ...
     SUBROUTINE using_eigts1(intento, debug_info)
         ...
         IF (eigts1_ood) THEN
             ...
             END IF
             IF (intento_ < 2) THEN
                IF ( iverbosity > 0 ) print *, "Really copied eigts1 D->H"
                eigts1 = eigts1_d
             END IF
             eigts1_ood = .false.
         ENDIF
     ...
     SUBROUTINE using_eigts1_d(intento, debug_info)
         ...
         IF (eigts1_d_ood) THEN
             ...
             IF (intento < 2) THEN
                IF ( iverbosity > 0 ) print *, "Really copied eigts1 H->D"
                eigts1_d = eigts1
             END IF
             eigts1_d_ood = .false.
         ENDIF
     ...
     SUBROUTINE using_eigts2(intento, debug_info)
         ...
         IF (eigts2_ood) THEN
             ...
             END IF
             IF (intento_ < 2) THEN
                IF ( iverbosity > 0 ) print *, "Really copied eigts2 D->H"
                eigts2 = eigts2_d
             END IF
             eigts2_ood = .false.
         ENDIF
     ...
     SUBROUTINE using_eigts2_d(intento, debug_info)
         ...
         IF (eigts2_d_ood) THEN
             ...
             IF (intento < 2) THEN
                IF ( iverbosity > 0 ) print *, "Really copied eigts2 H->D"
                eigts2_d = eigts2
             END IF
             eigts2_d_ood = .false.
         ENDIF
     ...
     SUBROUTINE using_eigts3(intento, debug_info)
         ...
         IF (eigts3_ood) THEN
             ...
             END IF
             IF (intento_ < 2) THEN
                IF ( iverbosity > 0 ) print *, "Really copied eigts3 D->H"
                eigts3 = eigts3_d
             END IF
             eigts3_ood = .false.
         ENDIF
     ...
     SUBROUTINE using_eigts3_d(intento, debug_info)
         ...
         IF (eigts3_d_ood) THEN
             ...
             IF (intento < 2) THEN
                IF ( iverbosity > 0 ) print *, "Really copied eigts3 H->D"
                eigts3_d = eigts3
             END IF
             eigts3_d_ood = .false.
         ENDIF
