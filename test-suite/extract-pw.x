...
# temporary workaround: only last occurrence of HOMO is actually checked
# (needed due to discrepancies in some calculations with hybrid functionals)
# temporarily missing: check on el1 (requires change in output format,
# update of all reference files)
