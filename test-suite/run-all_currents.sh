...
echo ' RUNNING ',"${PARA_PREFIX} ${ESPRESSO_ROOT}/bin/all_currents.sh ${PARA_POSTFIX} -input $1 > $2 2> $3"
${PARA_PREFIX} ${ESPRESSO_ROOT}/bin/all_currents.sh ${PARA_POSTFIX} -input $1 > $2 2> $3
