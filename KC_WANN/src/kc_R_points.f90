...
SUBROUTINE kc_R_points
  ...
  USE control_kc_wann,      ONLY : Rvect, mp1, mp2 ,mp3, irvect
  ...
  mptot=mp1*mp2*mp3
  IF (num_R .ne. mptot) &
     CALL errore('kc_R_points', ' Mismatch between num of kpoints and MP grid from input', num_R)
  !
