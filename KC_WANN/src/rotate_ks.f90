...
SUBROUTINE rotate_ks ()
  ...
  USE control_kc_wann,       ONLY : kc_at_ks, evc0, read_unitary_matrix, iuwfc_wann, &
  ...
  ENDDO k_loop
  !
  IF (check_ks .AND. .NOT. kc_at_ks )  WRITE( stdout, '(/,8x,A)') &
