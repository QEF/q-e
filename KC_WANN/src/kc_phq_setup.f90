...
subroutine kc_phq_setup
  ...
  USE control_ph,       ONLY : niter_ph, alpha_mix, reduce_io, flmixdpot
  ...
  !
  CALL stop_clock ('kc_phq_setup')
  !
  RETURN 
  !
END SUBROUTINE kc_phq_setup
