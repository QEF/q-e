...
subroutine bcast_kc_input ( )
  ...
  USE control_ph,    ONLY : recover, niter_ph, alpha_mix, nmix_ph, tr2_ph
  ...
  call mp_bcast ( kc_at_ks,            ionode_id, intra_image_comm )
  ...
  call mp_bcast ( compute_hf,          ionode_id, intra_image_comm )
