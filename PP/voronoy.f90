...
#include "machine.h"
  ...
  integer, pointer :: nlbig (:)  
  real(kind=DP), pointer :: partial_charge (:)
  complex(kind=DP), pointer :: rhobig (:)  
...
#include "machine.h"
  ...
  call mallocate(aux,nrx1 * nr2 * nr3)  
