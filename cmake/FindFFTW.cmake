...
#   - ARMPL:   to detect the FFTW from ARM Performance Library
...
if( FFTW_FIND_COMPONENTS )
  foreach( component ${FFTW_FIND_COMPONENTS} )
    ...
    if (${component} STREQUAL "ARMPL")
      # means we look for the ARM Performance Library version of FFTW
      set(FFTW_LOOK_FOR_ARMPL ON)
      if (FFTW_LOOK_FOR_FFTW_LONG)
        if (NOT FFTW_FIND_QUIETLY)
          message(WARNING "Looking for FFTW -- long precision functions do not exist in FFTW_ARMPL")
        endif()
        set(FFTW_LOOK_FOR_FFTW_LONG OFF)
      endif()
      if (FFTW_LOOK_FOR_FFTW_QUAD)
        if (NOT FFTW_FIND_QUIETLY)
          message(WARNING "Looking for FFTW -- quadruple functions do not exist in FFTW_ARMPL")
        endif()
        set(FFTW_LOOK_FOR_FFTW_QUAD OFF)
      endif()
      if (FFTW_LOOK_FOR_OMP)
        if (NOT FFTW_FIND_QUIETLY)
          message(WARNING "Looking for FFTW -- FFTW_ARMPL does not use OpenMP")
        endif()
        set(FFTW_LOOK_FOR_OMP OFF)
      endif()
    endif()
    if (${component} STREQUAL "ESSL")
      # means we look for the IBM ESSL version of FFTW
...
if (FFTW_LOOK_FOR_ARMPL)
  if (NOT FFTW_FIND_QUIETLY)
    message(STATUS "FFTW looks for ARM Performance Library")
  endif()
endif()
...
# -------------------------------------------------------------------------------------
if (NOT FFTW_LOOK_FOR_MKL AND NOT FFTW_LOOK_FOR_ARMPL AND NOT FFTW_LOOK_FOR_ESSL)
  ...
  if( PKG_CONFIG_EXECUTABLE AND NOT FFTW_GIVEN_BY_USER )
    ...
    if (FFTW3_FOUND)
      ...
      if(FFTW3_INCLUDE_DIRS)
        ...
        if (NOT FFTW_FIND_QUIETLY)
          message("FFTW3_INCLUDE_DIRS is empty using PkgConfig. "
...
if( (NOT PKG_CONFIG_EXECUTABLE) OR
  ...
  if(NOT FFTW_LOOK_FOR_MKL)
    ...
    if (FFTW_LOOK_FOR_ARMPL)
      if (FFTW_LOOK_FOR_OMP)
        set(FFTW_libs_to_find "armpl_mp")
      else ()
        set(FFTW_libs_to_find "armpl")
      endif()
    endif()
