...
if(BLA_VENDOR MATCHES "Armpl" OR BLA_VENDOR STREQUAL "All")
  if(NOT LAPACK_LIBRARIES)
    if(CMAKE_C_COMPILER_LOADED OR CMAKE_CXX_COMPILER_LOADED)
      ...
      if(LAPACK_VENDOR MATCHES "_64ilp")
        set(LAPACK_armpl_SEARCH "armpl_ilp64")
      else()
        set(LAPACK_armpl_SEARCH "armpl_lp64")
      endif()

      if(LAPACK_VENDOR MATCHES "_mp")
        if(LAPACK_FIND_QUIETLY OR NOT LAPACK_FIND_REQUIRED)
          find_package(OpenMP)
        else()
          find_package(OpenMP REQUIRED)
        endif()
        string(CONCAT LAPACK_armpl_SEARCH ${LAPACK_armpl_SEARCH} "_mp")
      endif()
