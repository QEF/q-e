...
#
# This module allows to find BLAS libraries by calling the official FindBLAS
# module and handles the creation of different library lists whether the user
# wishes to link with a sequential BLAS or a multihreaded (BLAS_SEQ_LIBRARIES
# and BLAS_PAR_LIBRARIES). BLAS is detected with a FindBLAS call then if the
# BLAS vendor is Intel10_64lp, ACML or IBMESSLMT then the module attempts to
# find the corresponding multithreaded libraries.
#
# The following variables have been added to manage links with sequential or
# multithreaded versions: BLAS_INCLUDE_DIRS  - BLAS include directories
# BLAS_LIBRARY_DIRS  - Link directories for BLAS libraries BLAS_SEQ_LIBRARIES -
# BLAS component libraries to be linked (sequential) BLAS_PAR_LIBRARIES - BLAS
# component libraries to be linked (multithreaded)
...
if(NOT BLAS_FOUND)
  # First try to detect two cases: 1: only SEQ libs are handled 2: both SEQ and
  # PAR libs are handled
  find_package_blas()
endif()
...
if(BLA_VENDOR MATCHES "Intel*")
  ...
  # Print_Find_Header_Status(blas mkl.h) endif ()
...
# extract libs paths remark: because it is not given by find_package(BLAS)
...
if(BLA_VENDOR MATCHES "Intel*")
  if(BLA_VENDOR MATCHES "Intel10_64lp*")
    if(NOT BLASEXT_FIND_QUIETLY)
      ...
      find_package_handle_standard_args(BLAS DEFAULT_MSG BLAS_SEQ_LIBRARIES
                                      BLAS_LIBRARY_DIRS BLAS_INCLUDE_DIRS)
    endif()
    if(BLAS_PAR_LIBRARIES)
      if(NOT BLASEXT_FIND_QUIETLY)
        message(STATUS "BLAS parallel libraries stored in BLAS_PAR_LIBRARIES")
        find_package_handle_standard_args(BLAS DEFAULT_MSG BLAS_PAR_LIBRARIES)
      endif()
    endif()
  else()
    if(NOT BLASEXT_FIND_QUIETLY)
