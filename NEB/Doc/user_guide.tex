...
\NEB\ is distributed together with \qe. {\bf QUESTO DOBBIAMO DECIDERLO}
...
Once \qe\ is corrently configured, \NEB\ can be compiled by
just typing \texttt{make neb}, from the main \qe\ directory;
or typing \make\ from the \texttt{NEB/} subdirectory.
\make\ will produce 
