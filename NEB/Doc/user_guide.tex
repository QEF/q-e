...
\neb\ is included inside the \qe\ distribution.
...
Typing \texttt{make neb} from the main \qe\ directory or
typing \texttt{make} from the NEB directory  will produce 
...
\texttt{bin/} subdirectory of the main espresso directory.
