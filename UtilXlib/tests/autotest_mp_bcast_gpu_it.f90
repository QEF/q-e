...
!
    ...
    it_h(10,10,10) = mpime
    it_d(10,10,10) = it_h(10,10,10)
    CALL mp_bcast(it_d, root, world_comm)
    it_h(10,10,10) = it_d(10,10,10)
    !
    CALL test%assert_equal(ALL(it_h .eq. 0) , .true. , fail=.true.)
    !
    it_h(10,10,10) = mpime
    it_d(10,10,10) = it_h(10,10,10)
    ...
    it_h(10,10,10) = it_d(10,10,10)
    !
    CALL test%assert_equal(ALL(it_h .eq. nproc-1) , .true. , fail=.true.)
    !
