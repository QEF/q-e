...
\end{enumerate}
The first option is the recommended one. You need to be registered on GitLab 
but you do not need to have write access to the repository. You need the 
...
\end{itemize}
% The following times, you will likely need to align your local repository
% to the ``develop'' branch, then align your remote repository as well:
% \begin{verbatim}
