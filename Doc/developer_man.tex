...
to directory \texttt{/to/be/changed} on the web site (requires system
privileges on the machine hosting the web server).
...
\begin{verbatim}
   ...
   archive/                 Makefile
   dev-tools/               License
   pseudo/                  test-suite     environment_variables
...
\end{verbatim}
\texttt{License}, \texttt{README.md} and \texttt{CONTRIBUTING.md}
have an obvious meaning. The other files and directories are related to
\begin{itemize}
