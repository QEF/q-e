...
Profeta, Guido Roma, Kurt Stokbro, Renata Wentzcovitch.
\end{quote}
...
The latest release of the PWscf source package can be downloaded from
the PWscf web site at this URL:
\smallskip
...
\noindent
The release corresponding to this manual is version \version.
