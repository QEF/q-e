...
The support for explicit OpenMP is steadingly improving.
...
on linear algebra (irequires compilation with ELPA and/or ScaLAPACK), 
...
for different jobs). The distributed format for
final data requires compilation with \verb|-D__OLDXML|
preprocessing option and will be removed
