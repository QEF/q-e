...
\begin{itemize}
  \item \texttt{NEB {\bf OPPURE PWneb? COME LO CHIAMIAMO?}}:
...
\texttt{NEB/}     & \texttt{PWneb} package\\
\texttt{PP/}      & \PostProc: utilities for post-processing of 
                    data produced by \PWscf \\
...
Here is a list:
\begin{itemize}
\item \texttt{make pw} compiles the \PWscf\ package.
