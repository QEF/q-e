...
path, as specified in the \texttt{PATH} variable.
...
\texttt{(C,F,F90,CPP,LD)FLAGS}& compilation/preprocessing/loader flags\\
...
{\em Please note}: If you change any settings (e.g. preprocessing flags) 
...
\item  \texttt{pwi2xsf.sh},  \texttt{pwo2xsf.sh} process respectively input and output
  ...
  requires the  \texttt{pwi2xsf.x} executables to be located somewhere in your
  \$PATH. 
