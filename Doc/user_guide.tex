...
for DFTI, \texttt{-D\_\_DFTI}; for ESSL, \texttt{-D\_\_ESSL} or
\texttt{-D\_\_LINUX\_ESSL}; for FFTW3, \texttt{-D\_\_FFTW3}; for
FFTW \texttt{-D\_\_FFTW}), to \texttt{DFLAGS} in the \texttt{make.sys} 
file.

If you have MKL libraries, you may also use the provided FFTW3 interface 
