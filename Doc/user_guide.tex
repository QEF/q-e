...
\begin{quote}
P. Giannozzi et al., http://arxiv.org/abs/0906.2569
\end{quote}
...
\begin{quote}
 ...
 ACML (\texttt{-lacml})
\end{quote}
Let us repeat it: you have to be VERY careful to prevent conflicts 
between the various kinds of parallelization. If you don't know how 
to run MPI processes and OpenMP threads in a controlled manner, forget
about mixed OpenMP-MPI parallelization.
