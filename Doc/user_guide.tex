...
organized in a square 2D grid. As aconsequence the number of processors
...
will add
\texttt{-D\_\_SCALAPACK} to DFLAGS in \texttt{make.sys} abd set LAPACK\_LIBS to something
like:
\begin{verbatim}
