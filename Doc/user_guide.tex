...
\paragraph{LIBXC}
\qe\ can use \texttt{libxc} libraries. You need to compile \texttt{libxc}
first. Then, look for "libxc" in \texttt{make.inc} and follow the 
instructions. Note that currently only a (small) subset of functionals 
implemented in \texttt{libxc} can be used and that the \libxc}-enabled 
