...
depending upon the site and personal environment. Only very
recent versions of the Cray compiler work, sort of.
With the \verb|PrgEnv-cray| module v.6.0.10, \texttt{ftn} v.14.0.3,
you run into the following problems:
\begin{itemize}
