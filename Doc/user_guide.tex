...
\begin{itemize}
  ...
  for the vdW-DF and vdW-DF2 functionals, with support from
  ...
  framework of DFT-D;
  \item Filippo Spiga (Cambridge) for mixed MPI-OpenMP parallelization;
...
\begin{quote}
  ...
  Bonf\`a, Claudia Bungaro, Paolo Cazzato, Gabriele Cipriani, 
