...
\item \texttt{GIPAW} (Gauge-Independent Projector Augmented Waves):
      NMR chemical shifts and EPR g-tensor, available at:
      \texttt{http://qe-forge.org/frs/?group_id=37}
\end{itemize}
...
was written by Davide Ceresoli (Univ. Oxford), Ari Seitsonen (Univ.Zurich),
...
This must be the same q-vector given in the input of \pwx.
...
libraries and sometimes even to flaky hardware. Sorry, not our fault.
