...
\end{verbatim}
{\em Note}: x86\_64 replaces amd64 since v.4.1. Cray Unicos machines, SGI 
...
Also, the phonon code is still not working with gfortran. Since however
gfoprtran is quickly evolving, the situation may quickly change.

\paragraph{Linux PCs with g95}

G95 (http://www.g95.org) works flawlessy. 
The executables it produces are definitely slower 
(let us say 20\% or so) that those produced by gfortran, which are slower 
