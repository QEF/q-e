...
In this section, we will show how to compile \qe\ with \texttt{PLUMED} plugin. First of all, one of the following version of the source package has to be downloaded:

\begin{itemize}
\item \qe\ release 4.3 (\href{http://qe-forge.org/frs/?group_id=10}{http://qe-forge.org/frs/?group\_id=10})
\item CVS version (\href{http://qe-forge.org/scm/?group_id=10}{http://qe-forge.org/scm/?group\_id=10})
\end{itemize}
