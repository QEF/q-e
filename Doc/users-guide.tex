...
\documentclass[12pt,a4paper]{article}
 \def\version{3.2}
 \def\stableversion{3.2} % last stable release
...
\begin{quote}
  ...
  \texttt{macos-xlf}: MAC OS-X for PPC machines with xlf\\
  \texttt{macos-intel}: MAC OS-X for Intel CPUs with ifort compiler and mkl\\
  ...
  \texttt{power5-aix-serial}: IBM Power5, serial\\ 
  \texttt{power5-aix-parallel}:IBM Power5, parallel\\
