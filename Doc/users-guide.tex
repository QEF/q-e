...
(fortran-90 is not sufficient, but most "fortran-90" compilers are 
actually fortran-95-compliant). If you do not have any, try the free 
\texttt{g95} compiler (\htmladdnormallink{\texttt{http://www.g95.org}}%
{http://www.pwscf.org/download.htm}):
it is still unfinished but already usable. You will also need basic unix
facilities: a shell, the \texttt{make} 
and \texttt{awk} utilities.
