...
scheme was contributed by V.H. Nguyen (Sissa and Hanoi University).
...
\begin{itemize}
  ...
  \item \texttt{VdW/} contains the sources  for the calculation of the 
        ...
        by V.H. Nguyen (Sissa and Hanoi University). Compile with
...
This may happens under special circumstances when you are calculating the band 
