...
\subsubsection{Exact-exchange functional with Wannier functions}
In this section, we illustrate some guidelines for doing linear-scaling of exact exchange (EXX) calculation with Wannier functions. 
...
&WANNIER
  ...
  exx_wf_fraction   = 0.25D0, ! exx related optional
/
ATOMIC_SPECIES
