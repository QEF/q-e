...
;; PWTK's cmds
(defvar pwtk-cmds (list "ATOMIC_POSITIONS_fromPWO" "ATOMIC_POSITIONS_fromXSF" "CELL_PARAMETERS_and_ATOMIC_POSITIONS_fromPWO" "CELL_PARAMETERS_and_ATOMIC_POSITIONS_fromXSF" "CELL_PARAMETERS_fromPWO" "CELL_PARAMETERS_fromXSF" "LL" "LSF" "QUEUE" "SH" "SLURM" "abort" "backup_io" "bands" "bi_fprint" "bi_get" "bin_dir" "bin_query" "calcmol" "card" "cardAppend" "cardClear" "cardContent" "cardFlags" "cardGet" "cardGetContent" "cardGetFlags" "cardPreppend" "cardPrint" "davi_fprint" "davi_get" "deleteAtoms" "deleteAtomsRange" "di_fprint" "di_get" "difden_run" "difden_segmentSpec" "dmi_fprint" "dmi_get" "dos" "dryrunPW" "dynmat" "eelsi_fprint" "eelsi_get" "eos_run" "fixAtoms" "fixAtoms1st" "fixAtomsLast" "fixAtomsRange" "hpi_fprint" "hpi_get" "ihandle" "import" "infoMsg" "input_clear" "input_handle" "input_pop" "input_push" "input_pushpop" "insertAtoms" "lani_fprint" "lani_get" "ll_clear" "ll_fprint" "ll_get" "ll_getBody" "ll_getHead" "ll_getScript" "ll_getSpecs" "ll_getTail" "ll_getVar" "ll_print" "ll_profile" "ll_profileDefault" "ll_rerunPH" "ll_rerunPW" "ll_run" "ll_runFLO" "ll_runPH" "ll_runPP" "ll_runPROJWFC" "ll_runPW" "ll_setHead" "ll_setSpecs" "ll_setTail" "ll_setVar" "ll_submit" "load_fromBI" "load_fromDAVI" "load_fromDI" "load_fromDMI" "load_fromEELSI" "load_fromHPI" "load_fromLANI" "load_fromMDI" "load_fromMPDI" "load_fromNEBI" "load_fromPHI" "load_fromPPI" "load_fromPRI" "load_fromPWI" "load_fromQ2RI" "load_fromSPECI" "lsf_clear" "lsf_fprint" "lsf_get" "lsf_getBody" "lsf_getHead" "lsf_getScript" "lsf_getSpecs" "lsf_getTail" "lsf_getVar" "lsf_print" "lsf_profile" "lsf_profileDefault" "lsf_rerunPH" "lsf_rerunPW" "lsf_run" "lsf_runFLO" "lsf_runPH" "lsf_runPP" "lsf_runPROJWFC" "lsf_runPW" "lsf_setHead" "lsf_setSpecs" "lsf_setTail" "lsf_setVar" "lsf_submit" "mdi_fprint" "mdi_get" "molecularpdos" "mpdi_fprint" "mpdi_get" "namelist" "namelistClear" "namelistGet" "namelistPrint" "neb" "nebi_fprint" "nebi_get" "nebi_visualize" "outdir" "outdir_clean" "outdir_create" "outdir_postfix" "outdir_prefix" "outdir_query" "ph" "phi_fprint" "phi_get" "phi_getAffix" "phi_getTitle" "postfix" "pp" "ppi_fprint" "ppi_get" "prefix" "pri_fprint" "pri_get" "print" "printAll" "printTitle" "projwfc" "pseudo_dir" "pw" "pwi_fprint" "pwi_get" "pwi_visualize" "pwo_alat" "pwo_dipole" "pwo_efermi" "pwo_etot" "pwo_press" "pwo_totene" "pwo_totfor" "q2ri_fprint" "q2ri_get" "queue_clear" "queue_fprint" "queue_get" "queue_getBody" "queue_getHead" "queue_getScript" "queue_getSpecs" "queue_getTail" "queue_getVar" "queue_print" "queue_profile" "queue_profileDefault" "queue_rerunPH" "queue_rerunPW" "queue_run" "queue_runFLO" "queue_runPH" "queue_runPP" "queue_runPROJWFC" "queue_runPW" "queue_setHead" "queue_setSpecs" "queue_setTail" "queue_setVar" "queue_submit" "relaxPW" "remote_exec" "replaceCoor" "rerunDAVID" "rerunEELS" "rerunLANCZOS" "rerunNEB" "rerunPH" "rerunPW" "restartPW_fromPWIandPWO" "run" "runBANDS" "runDAVID" "runDOS" "runDYNMAT" "runEELS" "runFLO" "runHP" "runLANCZOS" "runMATDYN" "runMOLECULARPDOS" "runMOPDOS" "runNEB" "runPH" "runPP" "runPROJWFC" "runPW" "runPW_remedy" "runQ2R" "runSPECTRUM" "sbco_postNeb" "sbco_restart" "sbco_run" "seq" "sh_clear" "sh_fprint" "sh_get" "sh_getBody" "sh_getHead" "sh_getScript" "sh_getSpecs" "sh_getTail" "sh_getVar" "sh_print" "sh_profile" "sh_profileDefault" "sh_rerunPH" "sh_rerunPW" "sh_run" "sh_runFLO" "sh_runPH" "sh_runPP" "sh_runPROJWFC" "sh_runPW" "sh_setHead" "sh_setSpecs" "sh_setTail" "sh_setVar" "sh_submit" "slurm_clear" "slurm_fprint" "slurm_get" "slurm_getBody" "slurm_getHead" "slurm_getScript" "slurm_getSpecs" "slurm_getTail" "slurm_getVar" "slurm_print" "slurm_profile" "slurm_profileDefault" "slurm_rerunPH" "slurm_rerunPW" "slurm_run" "slurm_runFLO" "slurm_runPH" "slurm_runPP" "slurm_runPROJWFC" "slurm_runPW" "slurm_setHead" "slurm_setSpecs" "slurm_setTail" "slurm_setVar" "slurm_submit" "speci_fprint" "speci_get" "substituteAtmType" "vc_relaxPW" "warning" "wfcdir" "wfcdir_clean" "wfcdir_create" "wfcdir_postfix" "wfcdir_prefix" "wfcdir_query" ))
