...
!        IF (okvan) CALL adddvscf(1, ik) 
     ...
     ! where alpha_pv = 0
     !
     !$acc data copyin(evc1(1:npwx*npol,1:nbnd,ik,1),sevc1_new(1:npwx*npol,1:nbnd,ik,1), et(:,ikk))
...
!        IF (okvan) CALL adddvscf(1, ik)
     ...
     ! where alpha_pv = 0
     !
     !$acc data copyin(evc1(1:npwx*npol,1:nbnd,ik,2),sevc1_new(1:npwx*npol,1:nbnd,ik,2), et(:,imk))
