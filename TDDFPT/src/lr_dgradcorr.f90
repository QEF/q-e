...
!
!--------------------------------------------------------------------
subroutine lr_dgradcorr (rho, grho, dvxc_rr, dvxc_sr, dvxc_ss, &
...
#include "f_defs.h"
 ...
 implicit none
  ...
  h (:, :, :) = (0.d0, 0.d0)
  do is = 1, nspin
     call lr_qgradient (xq, nrx1, nrx2, nrx3, nr1, nr2, nr3, nrxx, &
  ...
  do is = 1, nspin
     call lr_qgrad_dot (xq, nrx1, nrx2, nrx3, nr1, nr2, nr3, nrxx, &
  ...
  deallocate (gdrho)
  return
end subroutine lr_dgradcorr
!
!--------------------------------------------------------------------
subroutine lr_qgradient (xq, nrx1, nrx2, nrx3, nr1, nr2, nr3, nrxx, &
     a, ngm, g, nl, alat, ga)
  !--------------------------------------------------------------------
...
end subroutine lr_qgradient
!--------------------------------------------------------------------
subroutine lr_qgrad_dot (xq, nrx1, nrx2, nrx3, nr1, nr2, nr3, nrxx, &
     a, ngm, g, nl, alat, da)
  !--------------------------------------------------------------------
