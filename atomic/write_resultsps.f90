...
!
 ...
 1200 format(/5x,'eps =',1pe8.1,'  iter =',i3)
      write(6,*)
      write(6,1211) etot, etot*0.5d0, etot*13.6058d0
 1211 format (5x,'Etot =',f15.6,' Ry,',f15.6, ' Ha,',f15.6,' eV')
      write(6,1221) etots, etots*0.5d0, etots*13.6058d0
 ...
 1241 format (5x,'dEtot_ps =',f15.6,' Ry,','   Delta E=',f15.6 )
      ...
      write(6,1251) ekin, ekin*0.5d0, ekin*13.6058d0
 1251 format (/,5x,'Ekin =',f15.6,' Ry,',f15.6,' Ha,',f15.6,' eV')

      write(6,1261) encl, encl*0.5d0, encl*13.6058d0
 1261 format (5x,'Encl =',f15.6,' Ry,',f15.6, ' Ha,',f15.6,' eV') 
      write(6,1271) ehrt, ehrt*0.5d0, ehrt*13.6058d0
 1271 format (5x,'Ehrt =',f15.6,' Ry,',f15.6,' Ha,',f15.6,' eV') 
      write(6,1281) ecxc, ecxc*0.5d0, ecxc*13.6058d0
 1281 format (5x,'Ecxc =',f15.6,' Ry,',f15.6,' Ha,',f15.6,' eV')
      write(6,1291) evxt, evxt*0.5d0, evxt*13.6058d0
 1291 format(5x,'Evxt =',f15.6,' Ry,',f15.6,' Ha,',f15.6,' eV')
      write(6,1292) epseu, epseu*0.5d0, epseu*13.6058d0
