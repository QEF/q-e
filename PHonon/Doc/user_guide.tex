...
To use this functionality, first, a \phx calculation of $q$ points on a coarse
grid is required. Then, a \texttt{dvscf\_q2r.x} run performs an inverse Fourier
...
This treatment is activated specifying \texttt{do\_long\_range=.true.} in the
