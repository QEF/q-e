...
It is also assumed that you know the physics behing \qe,
...
\PHonon\ should read the Developer Manual: 
...
Links from the main \qe\ \texttt{bin/} directory are automatically generated.
