...
subroutine bcast_ph_input ( )
  ...
  call mp_bcast (ldiag, ionode_id, world_comm )
  call mp_bcast (lqdir, ionode_id, world_comm )
  call mp_bcast (qplot, ionode_id, world_comm )
  call mp_bcast (only_wfc, ionode_id, world_comm )
  call mp_bcast (only_init, ionode_id, world_comm )
  call mp_bcast (search_sym, ionode_id, world_comm)
  !
  ! integers
  !
  ...
  CALL mp_bcast( low_directory_check, ionode_id, world_comm )
  CALL mp_bcast( elph_nbnd_min, ionode_id, world_comm )
  CALL mp_bcast( elph_nbnd_max, ionode_id, world_comm )
  CALL mp_bcast( el_ph_ngauss, ionode_id, world_comm )
  ...
  !
  call mp_bcast (drho_star%open,  ionode_id, world_comm)
  call mp_bcast (drho_star%pat,   ionode_id, world_comm)
  call mp_bcast (drho_star%dir,   ionode_id, world_comm)
  call mp_bcast (drho_star%ext,   ionode_id, world_comm)
  call mp_bcast (drho_star%basis, ionode_id, world_comm)
  !
  call mp_bcast (dvscf_star%open,  ionode_id, world_comm)
  call mp_bcast (dvscf_star%pat,   ionode_id, world_comm)
  call mp_bcast (dvscf_star%dir,   ionode_id, world_comm)
  call mp_bcast (dvscf_star%ext,   ionode_id, world_comm)
  call mp_bcast (dvscf_star%basis, ionode_id, world_comm)
