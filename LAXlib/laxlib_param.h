...
!
   ...
   INTEGER LAX_STATUS_MEBLACS      ! me_blacs
   PARAMETER (LAX_STATUS_MEBLACS=12)
   INTEGER LAX_STATUS_NPBLACS      ! np_blacs
   PARAMETER (LAX_STATUS_NPBLACS=13)
   INTEGER LAX_STATUS_ORTHOCNTX    ! ortho_cntx
   PARAMETER (LAX_STATUS_ORTHOCNTX=14)
   INTEGER LAX_STATUS_WORLDCNTX    ! world_cntx
   PARAMETER (LAX_STATUS_WORLDCNTX=15)
   INTEGER LAX_STATUS_DISTDIAG     ! do_distr_diag_inside_bgrp
   PARAMETER (LAX_STATUS_DISTDIAG=16)
