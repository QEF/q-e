...
!writes on screen
    ...
    call mp_bcast(ggwin%l_pola_lanczos, ionode_id)
    call mp_bcast(ggwin%l_self_lanczos, ionode_id)
    call mp_bcast(ggwin%l_lanczos_conv, ionode_id)
    call mp_bcast(ggwin%n_set, ionode_id)
    call mp_bcast(ggwin%n_set_ii, ionode_id)
    call mp_bcast(ggwin%n_set_pola, ionode_id)
    call mp_bcast(ggwin%n_set_self, ionode_id)
    call mp_bcast(ggwin%l_yet_pola, ionode_id)
    call mp_bcast(ggwin%l_reduce_io, ionode_id)
    call mp_bcast(ggwin%second_grid_n, ionode_id)
    call mp_bcast(ggwin%second_grid_i, ionode_id)
    call mp_bcast(ggwin%l_t_wannier, ionode_id)
    call mp_bcast(ggwin%l_truncated_coulomb, ionode_id)
    call mp_bcast(ggwin%l_self_time, ionode_id)
    call mp_bcast(ggwin%l_g_grid, ionode_id)
    call mp_bcast(ggwin%grid_freq_g, ionode_id)
    call mp_bcast(ggwin%n_g, ionode_id)
    call mp_bcast(ggwin%second_grid_n_g, ionode_id)
    call mp_bcast(ggwin%second_grid_i_g, ionode_id)
    call mp_bcast(ggwin%omega_g, ionode_id)
    call mp_bcast(ggwin%i_min_whole, ionode_id)
    call mp_bcast(ggwin%i_max_whole, ionode_id)
    call mp_bcast(ggwin%nspin, ionode_id)
    call mp_bcast(ggwin%l_frac_occ, ionode_id)
    call mp_bcast(ggwin%l_semicore, ionode_id)
    call mp_bcast(ggwin%l_order, ionode_id)
    call mp_bcast(ggwin%l_verbose, ionode_id)
    call mp_bcast(ggwin%n_real_axis, ionode_id)
    call mp_bcast(ggwin%real_energy_min, ionode_id)
    call mp_bcast(ggwin%real_energy_max, ionode_id)
    call mp_bcast(ggwin%grid_levels, ionode_id)
    call mp_bcast(ggwin%l_big_system, ionode_id)
    call mp_bcast(ggwin%l_list, ionode_id)
    call mp_bcast(ggwin%l_full, ionode_id)
    call mp_bcast(ggwin%n_full, ionode_id)
#endif
