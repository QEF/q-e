  ...
  !----------------------------------------------------------------------
  !! 
  !! This module contains the routines related to the reading of the dynamical 
  !! matrix and imposition of ASR
  !! 
  IMPLICIT NONE
  ! 
  CONTAINS
    ...
    ENDIF
    !
    ALLOCATE(ind_v(9 * nat * nat * nr1 * nr2 * nr3, 2, 7))
    ALLOCATE(v(9 * nat * nat * nr1 * nr2 * nr3, 2))
    m = 0
    DO i = 1, 3
      DO j = 1, 3
        DO na = 1, nat
    ...
    !
    n_less = 0
    ALLOCATE(w(nr1, nr2, nr3, 3, 3, nat, nat))
    ALLOCATE(x(nr1, nr2, nr3, 3, 3, nat, nat))
    DO k = 1, p
      w(:, :, :, :, :, :, :) = u(k) % vec(:, :, :, :, :, :, :)
      x(:, :, :, :, :, :, :) = u(k) % vec(:, :, :, :, :, :, :)
      DO l = 1, m
