...
201 FORMAT('UNK', i5.5, '.', 'NC')                                                          
  ...
  REAL(KIND = DP), EXTERNAL :: s
  !! s-orbitals
  REAL(KIND = DP), EXTERNAL :: p_z, px, py
  !! p-orbitals
  REAL(KIND = DP), EXTERNAL :: dz2, dxz, dyz, dx2my2, dxy
  !! d-orbitals
  REAL(KIND = DP), EXTERNAL :: fz3, fxz2, fyz2, fzx2my2, fxyz, fxx2m3y2, fy3x2my2
  !! f-orbitals
  !
  bs2  = 1.d0 / SQRT(2.d0)
  bs3  = 1.d0 / SQRT(3.d0)
