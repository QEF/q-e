...
module fbuf_gpum
  ...
  integer, device, allocatable, target  :: data_iv1_d(:)
  logical :: lockediv1 = .false.
    
 
  integer, device, allocatable, target  :: data_iv2_d(:)
  logical :: lockediv2 = .false.
    
 
  integer, device, allocatable, target  :: data_iv3_d(:)
  logical :: lockediv3 = .false.
    
 
  integer, device, allocatable, target  :: data_iv4_d(:)
  logical :: lockediv4 = .false.
    
 
  integer, device, allocatable, target  :: data_iv5_d(:)
  logical :: lockediv5 = .false.
    
 
  integer, device, allocatable, target  :: data_iv6_d(:)
  logical :: lockediv6 = .false.
    
 
  integer, device, allocatable, target  :: data_iv7_d(:)
  logical :: lockediv7 = .false.
    
 
  integer, device, allocatable, target  :: data_iv8_d(:)
  logical :: lockediv8 = .false.
    
 
  integer, device, allocatable, target  :: data_iv9_d(:)
  logical :: lockediv9 = .false.
    
 

  integer, device, allocatable, target  :: data_im0_d(:,:)
  logical :: lockedim0 = .false.
    
 
  integer, device, allocatable, target  :: data_im1_d(:,:)
  logical :: lockedim1 = .false.
    
 
  integer, device, allocatable, target  :: data_im2_d(:,:)
  logical :: lockedim2 = .false.
    
 
  integer, device, allocatable, target  :: data_im3_d(:,:)
  logical :: lockedim3 = .false.
    
 
  integer, device, allocatable, target  :: data_im4_d(:,:)
  logical :: lockedim4 = .false.
    
 
  integer, device, allocatable, target  :: data_im5_d(:,:)
  logical :: lockedim5 = .false.
    
 
  integer, device, allocatable, target  :: data_im6_d(:,:)
  logical :: lockedim6 = .false.
    
 
  integer, device, allocatable, target  :: data_im7_d(:,:)
  logical :: lockedim7 = .false.
    
 
  integer, device, allocatable, target  :: data_im8_d(:,:)
  logical :: lockedim8 = .false.
    
 
  integer, device, allocatable, target  :: data_im9_d(:,:)
  logical :: lockedim9 = .false.
    
 

  integer, device, allocatable, target  :: data_it0_d(:,:,:)
  logical :: lockedit0 = .false.
    
 
  integer, device, allocatable, target  :: data_it1_d(:,:,:)
  logical :: lockedit1 = .false.
    
 
  integer, device, allocatable, target  :: data_it2_d(:,:,:)
  logical :: lockedit2 = .false.
    
 
  integer, device, allocatable, target  :: data_it3_d(:,:,:)
  logical :: lockedit3 = .false.
    
 
  integer, device, allocatable, target  :: data_it4_d(:,:,:)
  logical :: lockedit4 = .false.
    
 
  integer, device, allocatable, target  :: data_it5_d(:,:,:)
  logical :: lockedit5 = .false.
    
 
  integer, device, allocatable, target  :: data_it6_d(:,:,:)
  logical :: lockedit6 = .false.
    
 
  integer, device, allocatable, target  :: data_it7_d(:,:,:)
  logical :: lockedit7 = .false.
    
 
  integer, device, allocatable, target  :: data_it8_d(:,:,:)
  logical :: lockedit8 = .false.
    
 
  integer, device, allocatable, target  :: data_it9_d(:,:,:)
  logical :: lockedit9 = .false.
    
 

  real(DP), device, allocatable, target  :: data_rv0_d(:)
  logical :: lockedrv0 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rv1_d(:)
  logical :: lockedrv1 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rv2_d(:)
  logical :: lockedrv2 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rv3_d(:)
  logical :: lockedrv3 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rv4_d(:)
  logical :: lockedrv4 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rv5_d(:)
  logical :: lockedrv5 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rv6_d(:)
  logical :: lockedrv6 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rv7_d(:)
  logical :: lockedrv7 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rv8_d(:)
  logical :: lockedrv8 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rv9_d(:)
  logical :: lockedrv9 = .false.
    
 

  real(DP), device, allocatable, target  :: data_rm0_d(:,:)
  logical :: lockedrm0 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rm1_d(:,:)
  logical :: lockedrm1 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rm2_d(:,:)
  logical :: lockedrm2 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rm3_d(:,:)
  logical :: lockedrm3 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rm4_d(:,:)
  logical :: lockedrm4 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rm5_d(:,:)
  logical :: lockedrm5 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rm6_d(:,:)
  logical :: lockedrm6 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rm7_d(:,:)
  logical :: lockedrm7 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rm8_d(:,:)
  logical :: lockedrm8 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rm9_d(:,:)
  logical :: lockedrm9 = .false.
    
 

  real(DP), device, allocatable, target  :: data_rt0_d(:,:,:)
  logical :: lockedrt0 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rt1_d(:,:,:)
  logical :: lockedrt1 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rt2_d(:,:,:)
  logical :: lockedrt2 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rt3_d(:,:,:)
  logical :: lockedrt3 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rt4_d(:,:,:)
  logical :: lockedrt4 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rt5_d(:,:,:)
  logical :: lockedrt5 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rt6_d(:,:,:)
  logical :: lockedrt6 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rt7_d(:,:,:)
  logical :: lockedrt7 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rt8_d(:,:,:)
  logical :: lockedrt8 = .false.
    
 
  real(DP), device, allocatable, target  :: data_rt9_d(:,:,:)
  logical :: lockedrt9 = .false.
    
 

  complex(DP), device, allocatable, target  :: data_cv0_d(:)
  logical :: lockedcv0 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cv1_d(:)
  logical :: lockedcv1 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cv2_d(:)
  logical :: lockedcv2 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cv3_d(:)
  logical :: lockedcv3 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cv4_d(:)
  logical :: lockedcv4 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cv5_d(:)
  logical :: lockedcv5 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cv6_d(:)
  logical :: lockedcv6 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cv7_d(:)
  logical :: lockedcv7 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cv8_d(:)
  logical :: lockedcv8 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cv9_d(:)
  logical :: lockedcv9 = .false.
    
 

  complex(DP), device, allocatable, target  :: data_cm0_d(:,:)
  logical :: lockedcm0 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cm1_d(:,:)
  logical :: lockedcm1 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cm2_d(:,:)
  logical :: lockedcm2 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cm3_d(:,:)
  logical :: lockedcm3 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cm4_d(:,:)
  logical :: lockedcm4 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cm5_d(:,:)
  logical :: lockedcm5 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cm6_d(:,:)
  logical :: lockedcm6 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cm7_d(:,:)
  logical :: lockedcm7 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cm8_d(:,:)
  logical :: lockedcm8 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_cm9_d(:,:)
  logical :: lockedcm9 = .false.
    
 

  complex(DP), device, allocatable, target  :: data_ct0_d(:,:,:)
  logical :: lockedct0 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_ct1_d(:,:,:)
  logical :: lockedct1 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_ct2_d(:,:,:)
  logical :: lockedct2 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_ct3_d(:,:,:)
  logical :: lockedct3 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_ct4_d(:,:,:)
  logical :: lockedct4 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_ct5_d(:,:,:)
  logical :: lockedct5 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_ct6_d(:,:,:)
  logical :: lockedct6 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_ct7_d(:,:,:)
  logical :: lockedct7 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_ct8_d(:,:,:)
  logical :: lockedct8 = .false.
    
 
  complex(DP), device, allocatable, target  :: data_ct9_d(:,:,:)
...
20  CONTINUE 
    ...
    100 FORMAT ("Pointer passed to release_buffer matched buffer integer, device ", I2,". Buffer released, pointer set to NULL.")
...
20  CONTINUE 
    ...
    if (this%verbose) write(*,101) 
    100 FORMAT ("Pointer passed to release_buffer matched buffer real(DP), device ", I2,". Buffer released, pointer set to NULL.")
    101 FORMAT ("Pointer passed to release_buffer did not match any buffer! Data deallocated, pointer set to NULL.")
    102 FORMAT ("WARNING: Pointer passed to release_buffer is not associated! Pointer set to NULL.")
...
20  CONTINUE 
    ...
    if (this%verbose) write(*,101) 
    100 FORMAT ("Pointer passed to release_buffer matched buffer complex(DP), device ", I2,". Buffer released, pointer set to NULL.")
    101 FORMAT ("Pointer passed to release_buffer did not match any buffer! Data deallocated, pointer set to NULL.")
    102 FORMAT ("WARNING: Pointer passed to release_buffer is not associated! Pointer set to NULL.")
...
#if defined(__CUDA)
    USE fbuf, ONLY : buf_t
    USE fbuf_gpum, ONLY : buf_t_gpu => buf_t
    !
    IMPLICIT NONE
    !
    TYPE(buf_t)     :: cpu_buffer
    TYPE(buf_t_gpu) :: gpu_buffer
#endif
end module fftx_buffers
